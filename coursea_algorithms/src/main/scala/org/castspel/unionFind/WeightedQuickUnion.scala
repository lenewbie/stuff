...
/**
 * Weighted Quick Union algorithm and data structure for dynamic connectivity problem.
 */
case class WeightedQuickUnion(numberOfElements: Int) {
  ...
  def union(firstElement: Int, secondElement: Int): WeightedQuickUnion = {
